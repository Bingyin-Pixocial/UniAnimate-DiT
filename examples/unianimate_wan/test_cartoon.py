...
test_list_path= [
    ...
    # [1, "data/pix/Taiyi.jpg", "data/saved_pose/cartoon_test_dance3/Taiyi"],
    [1, "data/pix/Doraemon.png", "data/saved_pose/cartoon_test_dance3/Doraemon/aligned_poses"],
    # [1, "data/pix/Taiyi.jpg", "data/saved_pose/dance1/Taiyi"],
    # [1, "data/pix/Hatsune_Miku.jpg", "data/saved_pose/dance1/Hatsune_Miku"],
    # [1, "data/pix/Taiyi.jpg", "data/saved_pose/dance2/Taiyi"],
    # [1, "data/pix/Hatsune_Miku.jpg", "data/saved_pose/dance2/Hatsune_Miku"],
    # [1, "data/pix/Taiyi.jpg", "data/saved_pose/dance3/Taiyi"],
    # [1, "data/pix/Hatsune_Miku.jpg", "data/saved_pose/dance3/Hatsune_Miku"],
]
