...
| 4 | Relative hand/face alignment | **Full-body hands:** Wrist-based only when shoulder–elbow–wrist valid and hand attached to wrist; else neck-based. **Face:** (1) Nose delta so face follows body movement; (2) reference face size applied only when it would enlarge the face (scale up to match ref extent, never shrink) to avoid compacted/shrunken face. **Partial-body:** Stage 1 same; stage 2 applies ref_name face size to already-transformed face. |
