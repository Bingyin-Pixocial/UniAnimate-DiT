...
| 4 | Relative hand/face alignment | **Full-body hands:** Wrist-based only when shoulder–elbow–wrist valid and hand attached to wrist; else neck-based. **Face:** (1) Nose delta so face follows body movement; (2) reference image face keypoints used only for face size (scale translated face to match ref extent). **Partial-body:** Stage 1 same; stage 2 applies ref_name face size to already-transformed face. |
