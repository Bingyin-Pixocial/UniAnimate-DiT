...
class WanVideoPipeline(BasePipeline):
    ...
    def __call__(
        ...
        #  NoiseInitializer(), InputVideoEmbedder(), PromptEmbedder(), ImageEmbedderVAE(), ImageEmbedderCLIP(), ImageEmbedderFused(), UnifiedSequenceParallel(), TeaCache()
...
class WanVideoUnit_ShapeChecker(PipelineUnit):
    ...
    def process(self, pipe: WanVideoPipeline, height, width, num_frames):
        ...
        if num_frames % 4 != 1:
            ...
            print(f"Only `num_frames % 4 != 1` is acceptable. Wan2.2 round it up to {num_frames}.")
